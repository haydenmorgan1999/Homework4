...
GET_result <- GET("https://newsapi.org/v2/everything?q=Vaccine&from=2025-06-01&apiKey=b4902a7135914e3da8e0cf971b2e8fd3")
...
query_API <- function(title, YYYY_MM_DD, API_key){
  GET_result <- GET(paste0("https://newsapi.org/v2/everything?q=", title, "&from=", YYYY_MM_DD, "&apiKey=", API_key))
